...
public:
	static const int BufferCount=6; //started at 2 in YummyDSP lib
	static const int BufferSize=32;//32; // increase to 64 samples to avoid drop outs (at 192 kHz)
    ...
    int setupBuiltin(int fs=11200, int channelCount=2, i2s_port_t i2s_port=(i2s_port_t)(0));
